...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('thumb-single', 830, '', true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
    add_image_size('thumb-home', 347, '', true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
...
function roots_jquery_local_fallback($src, $handle = null) {
  ...
  if ($add_jquery_fallback) {
    echo '<script>window.jQuery || document.write(\'<script src="' . get_template_directory_uri() . '/js/lib/jquery.min.js"><\/script>\')</script>' . "\n";
...
function html5blank_footer_scripts()
{
		    	...
		    	wp_register_script('bootstrapJs', '//maxcdn.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js', array(), '3.1.5'); // Conditionizr
...
{
    wp_register_style('bootstrap', 'http://maxcdn.bootstrapcdn.com/bootstrap/3.2.0/css/bootstrap.min.css', array(), '3.2', 'all');
...
function register_boots_menu()
{
    register_nav_menus(array( // Using array to specify more menus if needed
     'primary' => __( 'Primary Menu', 'bootstrap_nav' )
...
add_action('init', 'register_boots_menu'); // Add HTML5 Blank Menu
